...
//
// for (const objKey in obj) {
//     console.log(`${objKey} - зарплата ${obj[objKey]} $`)
// }
...
// for (const number of m) {
//
//     if (String(number)[0] == '1' || String(number)[0] == '2' || String(number)[0] == 5 ) {
//         console.log(number)
//     }
// }
...
// for (let i = 0; i < week.length; i++) {
//     if (day === i) {
//         document.write(`<i>${week[i]} - it's today!</i>`)
//     }
//     else {
//         document.write(`<p>${week[i]}</p>`)
//     }
...
// }
// else {
//     document.write(`<h2>remainder ${a%b}</h2>`)
// }
...
//
// while (i < 10) {
//  m.push(Math.round(Math.random()*100000))
//
//     i++
// }
//
